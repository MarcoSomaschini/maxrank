...
Hypercube::Hypercube(const int a_dimen, const float *a_l, const float *a_u) :
        m_lower(a_dimen, a_l), m_upper(a_dimen, a_u) {}
...
Hypercube::Hypercube(const Hypercube &a_hc) :
        m_lower(a_hc.m_lower), m_upper(a_hc.m_upper) {}
...
int Hypercube::EncloseWhichQuadrant(const Hypercube &a_hc0, const Hypercube &a_hc1,
                                    int qd_ID[]) const//which quadrant of hc1 is enclosed by hc0
{
...
int Hypercube::inWhichStripe(const Hypercube &a_hc0, const Hypercube &a_hc1,
                             int stripe[]) const //a_hc0 falls in which stripe of a_hc1
{
    //*
    if (a_hc0.m_lower[0] == a_hc0.m_upper[0])  //current MBR is a vertical line
    {
        ...
        if (a_hc0.m_lower[1] >= a_hc1.m_upper[1] && a_hc0.m_lower[0] >= a_hc1.m_lower[0] &&
            a_hc0.m_upper[0] <= a_hc1.m_upper[0])    //the up-side
        {
            stripe[1] = 1;
        }
        ...
        if (a_hc0.m_upper[1] <= a_hc1.m_lower[1] && a_hc0.m_lower[0] >= a_hc1.m_lower[0] &&
            a_hc0.m_upper[0] <= a_hc1.m_upper[0])    //the down-side
        {
            stripe[3] = 1;
        }
    } else if (a_hc0.m_lower[1] == a_hc0.m_upper[1])   //current MBR is a horizontal line
    {
        if (a_hc0.m_lower[0] >= a_hc1.m_upper[0] && a_hc0.m_lower[1] >= a_hc1.m_lower[1] &&
            a_hc0.m_upper[1] <= a_hc1.m_upper[1])    //the right-side
        {
            stripe[0] = 1;
        }
        ...
        if (a_hc0.m_upper[0] <= a_hc1.m_lower[0] && a_hc0.m_lower[1] >= a_hc1.m_lower[1] &&
            a_hc0.m_upper[1] <= a_hc1.m_upper[1])    //the left-side
        {
            stripe[2] = 1;
        }
    ...
    } else //*/
    {
        ...
        if ((a_hc0.m_lower[0] >= a_hc1.m_lower[0]) &&
            (a_hc0.m_upper[0] <= a_hc1.m_upper[0])    //a_hc0 is enclosed by a_hc1
...
int Hypercube::inWhichQuadrant(const Hypercube &a_hc0, const Hypercube &a_hc1,
                               int quadrant[]) const//a_hc0 falls in which quadrant of a_hc1
{
