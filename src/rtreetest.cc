/* ----------------------------------------------------------------------------
    This program:
    1. creates a Rtree based on approches described in SIGMOD84 R-tree paper
...
int main(const int a_argc, const char** a_argv)
{
    ...
    Rtree rtree(mem, dimen, maxChild, maxChild,
        (int)ceil(maxChild * 0.3), (int)ceil(maxChild * 0.3), false); 

    //-------------------------------------------------------------------------
    // insert objects to Rtree
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    // test 6. test if Rtree can remove objects
    //-------------------------------------------------------------------------
    cout << "deletion test ... ";
    int objdel=0;
