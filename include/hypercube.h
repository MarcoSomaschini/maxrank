...
public:
    ...
    float mindist(                                // min distance to a point on dimen d
            const Point &a_pt,
            const int a_dimen) const;
    ...
    int EncloseWhichQuadrant(const Hypercube &a_hc0, const Hypercube &a_hc1,
                             int qd_ID[]) const;//which quadrant of hc1 is enclosed by hc0

    int inWhichStripe(const Hypercube &a_hc0, const Hypercube &a_hc1,
                      int stripe[]) const;//a_hc0 falls in which stripe of a_hc1
    int inWhichQuadrant(const Hypercube &a_hc0, const Hypercube &a_hc1,
